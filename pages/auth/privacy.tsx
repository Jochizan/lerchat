...
const PrivacyPage: NextPage = () => {
  return (
    <div className='tx-wlight p-5'>
      <p>
        <strong>POLÍTICA DE PRIVACIDAD</strong>
      </p>
      <p>
        El presente Política de Privacidad establece los términos en que Tiquor
      ...
      <p>
        Tiquor está altamente comprometido para cumplir con el compromiso de
      ...
      <p>
        ...
        <Link href='/contact'>noticias</Link>. Usted puede aceptar o negar el
      ...
      <p>
        Tiquor Se reserva el derecho de cambiar los términos de la presente
