...
const TermsPage: NextPage = () => {
  return (
    <div className='tx-wlight p-5 text-justify'>
      ...
      <p>
        ...
        productos. lerchat.live no asume la responsabilidad en caso de que
      ...
      <p>
        Tiquor&nbsp; a través de su sitio web concede una licencia para que los
      ...
      <p>
        Este lerchat.live garantiza que la{' '}
        <Link href='/auth/privacy'>privacidad</Link> e información personal que usted
      ...
      <p>
        Tiquor reserva los derechos de cambiar o de modificar estos términos sin
        previo aviso.
      </p>
    </div>
  );
